...
function MathQuestions (list: any[]) {
...
let animatiONS = [sprites.create(img`
    ....................8a8aa8a8....................
    .................aaa888aa8a8aaa.................
    ...
    `, SpriteKind.House)]
animatiONS[1].setFlag(SpriteFlag.Ghost, true)
tiles.placeOnRandomTile(animatiONS[0], sprites.builtin.crowd0)
tiles.placeOnRandomTile(animatiONS[1], sprites.builtin.crowd4)
// a list with houses as arrays
let maths = ["What is 2 times 2?", "What is "]
// a list with houses as arrays
animatiONS = []
